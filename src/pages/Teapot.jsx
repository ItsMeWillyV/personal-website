  ...
  return (
    <>
      <Helmet key={window.location.pathname}>
        ...
        <meta name="keywords" content="Willy Vanderpool, WillyV, Teapot, 418, Easter Egg, Computer Science, Full Stack Developer" />
        ...
        {/* Schema.org markup */}
        <meta itemProp="name" content="418 - I'm a Teapot" />
